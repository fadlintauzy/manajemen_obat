...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-6 flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-gray-500">Perbarui informasi data obat</p>
        </div>
    </div>

    <!-- Form Card -->
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <form action="{{ route('medicines.update', $medicine->id_obat) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" name="nama_obat" id="nama_obat" value="{{ old('nama_obat', $medicine->nama_obat) }}" required 
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="dosis" id="dosis" value="{{ old('dosis', $medicine->dosis) }}" required 
                        class="w-full px-4 py-2 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all placeholder-gray-400"
            ...
            <div>
                ...
                <input type="text" name="category" id="category" value="{{ old('category', $medicine->category) }}" required 
                    class="w-full px-4 py-2 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all placeholder-gray-400"
